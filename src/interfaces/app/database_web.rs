...
impl DatabaseWeb {
    pub async fn new() -> Result<Self, Box<dyn std::error::Error>> {
        ...
        println!("DATABASE_URL: {:?}", database_url); // Verificação adicional
    ...
    pub async fn get_client(&self) -> Result<deadpool_postgres::Client, Box<dyn std::error::Error>> {
    ...
    pub async fn insert_task(&self, task: &Task) -> Result<(), Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
    ...
    pub async fn task_exists(&self, task_name: &str) -> Result<bool, Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
    ...
    pub async fn get_tasks(&self) -> Result<Vec<(String, String, String, Priority, Status)>, Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
    ...
    pub async fn update_task_database(&self, task_name: &str, task: &Task) -> Result<(), Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
        let date_str = task.date.format("%Y-%m-%d").to_string();
        let time_str = task.time.format("%H:%M:%S").to_string();
    ...
    pub async fn update_task_status(&self, task: &str) -> Result<(), Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
    ...
    pub async fn remove_task(&self, name: &str) -> Result<(), Box<dyn std::error::Error>> {
        let client = self.get_client().await?;
